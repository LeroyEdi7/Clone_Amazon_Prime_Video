...
export default function App() {
  ...
  const handleSubmit = (e) => {
    ...
    if (!name || !email || !message) {
      setFormStatus({ msg: "Please fill all fields.", color: "red" });
      return;
    }
    if (!validateEmail(email)) {
      setFormStatus({ msg: "Please enter a valid email.", color: "red" });
      return;
    }
  ...
  return (
    <>
      ...
      <div
        style={{ background: bg, color: textCol, minHeight: "100vh" }}
      ...
      >
        ...
        >
          ...
          >
            ...
            <li style={{ padding: "0 10px" }}>
              <a
                href="#channels"
                onClick={(e) => { e.preventDefault(); scrollTo("channels"); }}
                style={{ color: textCol }}
              >
                Movies
              </a>
            ...
            <li style={{ padding: "0 10px" }}>
              <a
                href="#popcorn"
                onClick={(e) => { e.preventDefault(); scrollTo("popcorn"); }}
                style={{ color: textCol }}
              >
                TV Shows
              </a>
            ...
            <li style={{ padding: "0 10px" }}>
              <a href="#" style={{ color: textCol }}>Live TV</a>
            </li>
            <li style={{ padding: "0 10px" }}>
              <a href="#" style={{ color: textCol }}>Subscriptions</a>
            </li>
          </ul>
        ...
        {showCategories && (
          ...
          >
            ...
            <div style={{ display: "flex", gap: 40 }}>
              ...
              <div>
                <div style={{ fontFamily: "Lato", marginBottom: 10, color: "#aaa" }}>
                  Other categories
                </div>
                {[
                ...
                {col.map((lang) => (
                  <div
                    ...
                    style={{
                      fontFamily: "Lato",
                      fontSize: 16,
                      color: lang === "English" ? "white" : "#c4cacf",
                      padding: "12px 16px",
                      cursor: "pointer",
                    }}
                    onMouseEnter={(e) =>
                      (e.currentTarget.style.backgroundColor = "#64778a")
                    }
                    onMouseLeave={(e) =>
        ...
        >
          ...
          <div style={{ flex: "1 1 340px", maxWidth: 520 }}>
            ...
            <div style={{ marginTop: 30, display: "flex", alignItems: "center" }}>
              <svg width="140" height="1" viewBox="0 0 140 1">
                <rect width="140" height="1" fill={isLight ? "#555" : "#fff"} />
              </svg>
              <span
                style={{
                  fontFamily: "Lato",
        ...
        <section
          id="channels"
          style={{ padding: "60px 100px", backgroundColor: bg }}
        >
          <div
            style={{
              display: "flex",
          ...
          >
            <div>
              ...
              >
                Your favorite channels all in one
                <br />
                place
              </h1>
              <p
                style={{
                  ...
                  fontFamily: "Lato",
                  fontWeight: 300,
                  color: isLight ? "#444" : "#d3cfcf",
                }}
              >
                Customers can subscribe to get access to a variety of premium
                and specialty content, easily accessible within the Prime Video
                app
              </p>
            </div>
          </div>
          ...
          >
            {[
              {
                name: "HBO",
                img: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/de/HBO_logo.svg/400px-HBO_logo.svg.png",
                bg: "#1a1a2e",
              },
              {
                name: "Showtime",
                img: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/22/Showtime.svg/400px-Showtime.svg.png",
                bg: "#c0392b",
              },
              {
                name: "Starz",
                img: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5f/Starz_2016.svg/400px-Starz_2016.svg.png",
                bg: "#000",
              },
              {
                name: "Discovery+",
                img: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/34/Discovery%2B_logo.svg/400px-Discovery%2B_logo.svg.png",
                bg: "#0d47a1",
              },
              {
                name: "Paramount+",
                img: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/Paramount_Network_logo.svg/400px-Paramount_Network_logo.svg.png",
                bg: "#003087",
              },
              {
                name: "ESPN+",
                img: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/ESPN%2B_logo.svg/400px-ESPN%2B_logo.svg.png",
                bg: "#cc0000",
              },
              {
                name: "AMC+",
                img: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6e/AMC_Networks_logo.svg/400px-AMC_Networks_logo.svg.png",
                bg: "#111",
              },
              {
                name: "Cinemax",
                img: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Cinemax_logo_2014.svg/400px-Cinemax_logo_2014.svg.png",
                bg: "#1a1a1a",
              },
              {
                name: "BritBox",
                img: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/35/BritBox_logo.svg/400px-BritBox_logo.svg.png",
                bg: "#003087",
              },
            ].map((ch, i) => (
              <div
          ...
          <div style={{ color: isLight ? "#111" : "white", maxWidth: 500 }}>
            ...
            <p
              style={{
                ...
                fontFamily: "Lato",
                fontWeight: 300,
                color: isLight ? "#444" : "#E1E1E1",
              }}
            >
              Even more movies, now available to rent—no Prime membership
              required
            </p>
            <button
              style={{
          ...
          <div style={{ width: "100%", maxWidth: 500, textAlign: "center" }}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                ...
                onMouseEnter={(e) =>
                  (e.currentTarget.style.backgroundColor = "#1a9ada")
                }
                onMouseLeave={(e) =>
                  (e.currentTarget.style.backgroundColor = "#0F79AF")
                }
              >
                Send Message
              </button>
              ...
              {formStatus.msg && (
                <p style={{ marginTop: 15, fontSize: 14, color: formStatus.color }}>
                  {formStatus.msg}
                </p>
              )}
            </form>
